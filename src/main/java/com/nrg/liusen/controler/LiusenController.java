...
public interface LiusenController {
	...
	public String inserEmployee(com.nrg.liusen.domain.EmployeeDataBean employeeDataBean);
	...
	public List<StockDataBean> getStockInListByVendor(StockDataBean stockDataBean);
